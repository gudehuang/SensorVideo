 ...
 */
public class JavaCameraViewH extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public JavaCameraViewH(Context context, int cameraId) {
        super(context, cameraId);
    }

    public JavaCameraViewH(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (JavaCameraViewH.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            JavaCameraViewH.this.wait();
                        }
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
