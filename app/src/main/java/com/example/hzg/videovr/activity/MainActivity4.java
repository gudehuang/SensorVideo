...
public class MainActivity4 extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case CANCEL_PROGRESSDIALOG:
                    ...
                    progressDialog = null;
                    Toast.makeText(MainActivity4.this, filename + "已保存", Toast.LENGTH_LONG).show();
                default:
...
//        Core.flip(mRgba, mRgba, 1);
    ...
    class ButtonOnclick {
        ...
        public void OnclickStart(int position, String text, int color, int type) {
            ...
            videoRecoder = new VideoRecoderList(MainActivity4.this, type, filename, VideoWriter.fourcc('M', 'J', 'P', 'G'), 18, framesize);
    ...
    private class RecoderWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (MainActivity4.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            MainActivity4.this.wait();
                        }
