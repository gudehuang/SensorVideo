...
public class MainActivity2 extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case CANCEL_PROGRESSDIALOG:
                    ...
                    progressDialog = null;
                    Toast.makeText(MainActivity2.this, filename + "已保存", Toast.LENGTH_LONG).show();
                default:
    ...
    class ButtonOnclick {
        ...
        public void OnclickStart(int position, String text, int color, int type) {
            ...
            videoRecoder = new VideoRecoderList(MainActivity2.this, type, filename, VideoWriter.fourcc('M', 'J', 'P', 'G'), 18, framesize);
