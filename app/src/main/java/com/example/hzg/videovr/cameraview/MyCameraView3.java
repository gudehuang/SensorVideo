 ...
 */
public class MyCameraView3 extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public MyCameraView3(Context context, int cameraId) {
        super(context, cameraId);
    }

    public MyCameraView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//                    mCameraFrame[1] = new JavaCameraFrame(mFrameChain[1], mFrameHeight, mFrameWidth);
    ...
    public void onPreviewFrame(byte[] frame, Camera arg1) {
      ...
      if (tempFrame==null)
        ...
        rotateYUV240SP(frame,tempFrame,mFrameHeight,mFrameWidth);
        synchronized (this) {
    ...
    private class JavaCameraFrame implements CvCameraViewFrame {
        ...
        @Override
        public Mat rgba() {
           //  Core.transpose(mYuvFrameData,mRgbaC);
            Imgproc.cvtColor(mYuvFrameData,mRgbaT, Imgproc.COLOR_YUV2RGBA_NV21, 4);
//            Core.transpose(mRgbaT,mRgbaC);
//            //mat.release();
//            //transpose（src,targe） 将目标倒转 如840*480变为480*840
//            Core.flip(mRgbaC, mRgba, 1);
            return mRgba;
        }
        ...
        public JavaCameraFrame(Mat Yuv420sp, int width, int height) {
            ...
            mRgbaT = new Mat();
            mRgbaC = new Mat();
            mRgbaF =new Mat(mFrameWidth*3/2,mFrameHeight,CvType.CV_8UC1);
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                ...
                synchronized (MyCameraView3.this) {
                    try {
                        while (!mCameraFrameReady && !mStopThread) {
                            MyCameraView3.this.wait();
                        }
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
